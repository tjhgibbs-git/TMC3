execute if score $prng prngone matches 12.. run summon drowned ~ ~ ~ {Health:12f,Attributes:[{Name:generic.max_health,Base:12}]}
execute if score $prng prngone matches 7..11 run summon skeleton ~ ~ ~ {Health:12f,HandItems:[{id:"minecraft:bow",Count:1b},{}],Attributes:[{Name:generic.max_health,Base:12}]}
