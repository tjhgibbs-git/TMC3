...
# initiate scoreboards to track map settings
scoreboard objectives add tmc.settings dummy

# used to track which advancements have been granted in that tick
scoreboard objectives add ic_track dummy
scoreboard objectives add ui_track dummy
